...
class FaceDetector:
    ...
    def detect_faces(self, frame):
        ...
        face_locations_scaled = face_locations
        ...
        for face_encoding, (top, right, bottom, left) in zip(face_encodings, face_locations_scaled):
            ...
            # unknown face detected and training mode enabled
    ...
    def broadcast_face_data(self, face_locations, face_ids):
        ...
        for (top, right, bottom, left), face_id in zip(face_locations, face_ids):
            ...
            if face_id is not None:
                ...
                if person is not None:
                    ...
                    # If the person has an image to replace the face with, use it
        ...
        # send the face data to the web page
        ...
        # send the control data to the web page
